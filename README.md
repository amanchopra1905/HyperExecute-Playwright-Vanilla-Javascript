# Run Playwright Vanilla JavaScript Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
```bash
git clone https://github.com/LambdaTest/HyperExecute-Playwright-Vanilla-JavaScript && cd HyperExecute-Playwright-Vanilla-JavaScript
npm install
```
